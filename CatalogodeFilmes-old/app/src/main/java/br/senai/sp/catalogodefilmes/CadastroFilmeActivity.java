...
public class CadastroFilmeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imgFoto = findViewById(R.id.imageview_filme);
        ...
        btnGaleria.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivityForResult(intentGaleria, 5000);
            }
        });
        ...
        btnCamera.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(CadastroFilmeActivity.this, "Chamando a camera", Toast.LENGTH_LONG).show();
            }
        });
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        //Toast.makeText(CadastroFilmeActivity.this, "Foto escolhida", Toast.LENGTH_LONG).show();


        try {

            //Toast.makeText(CadastroFilmeActivity.this, "teste", Toast.LENGTH_LONG).show();
